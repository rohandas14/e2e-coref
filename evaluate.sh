...
python3 evaluate.py -c multilingual-bert-base-polish -p 'multilingual-bert-base-fp32/baseline/polish/ckpt_epoch-059.pt.tar'

# python3 evaluate.py -c multilingual-bert-base-russian -p 'multilingual-bert-base-fp32/baseline/russian/ckpt_epoch-299.pt.tar'